...
- (void)setDataCount:(int)count range:(double)range
{
    ...
    for (int z = 0; z < 3; z++)
    {
        ...
        LineChartDataSet *d = [[LineChartDataSet alloc] initWithEntries:values label:[NSString stringWithFormat:@"DataSet %d", z + 1] xAxisAccessibilityLabel:nil yAxisAccessibilityLabel:nil];
        d.lineWidth = 2.5;
        d.circleRadius = 4.0;
